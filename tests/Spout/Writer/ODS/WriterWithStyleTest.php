...
class WriterWithStyleTest extends TestCase
{
    ...
    public function testBorders()
    {
        ...
        $widthMap = \ReflectionHelper::getStaticValue(Helper\BorderHelper::class, 'widthMap');
        $styleMap = \ReflectionHelper::getStaticValue(Helper\BorderHelper::class, 'styleMap');
